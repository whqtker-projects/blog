...
![B+Tree structure diagram](/images/btree-structure.svg)

## Internal Links

For background on why indexes exist, see [What Is a Database Index?](/posts/what-is-a-database-index).
For a detailed explanation of the tree structure, see [B+Tree Index Structure](/posts/b-plus-tree-index).
