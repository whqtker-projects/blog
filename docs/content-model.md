...
- graph-friendly series-link usage is limited to series index bodies rather than post bodies
- idea-stage post stubs remain valid as frontmatter-only or minimal-body notes without explicit graph links
...
- parent series index bodies may link to their child series
- child series index bodies may link to their parent series
